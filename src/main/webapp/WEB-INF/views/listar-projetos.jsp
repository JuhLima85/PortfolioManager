				...
				<table class="table table-bordered table-striped">
					<thead>
						<tr>
							...
							<th class="align-middle text-center">Orçamento (R$)</th>
						...
						<c:forEach var="projeto" items="${projetos}">
							<tr>
								...
								<td class="align-middle text-center"><fmt:formatDate
										value="${projeto.dataInicio}" pattern="dd/MM/yyyy" /></td>
								<td class="align-middle text-center"><fmt:formatDate
										value="${projeto.dataPrevisaoFim}" pattern="dd/MM/yyyy" /></td>
								<td class="align-middle text-center"><c:choose>
										<c:when test="${projeto.status == 'Encerrado'}">
											<fmt:formatDate value="${projeto.dataFim}"
												pattern="dd/MM/yyyy" />
										</c:when>
										<c:otherwise>
          									  -
